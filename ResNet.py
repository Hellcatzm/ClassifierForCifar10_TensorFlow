...
class ResNet:
    def __init__(self):
        ...
        with tf.variable_scope("layer2"):
            layer2 = self._make_layer(layer1, outchannel=64, block_num=3, stride=2, train=self.is_training)
        with tf.variable_scope("layer3"):
            layer3 = self._make_layer(layer2, outchannel=128, block_num=3, train=self.is_training)
        with tf.variable_scope("layer4"):
            layer4 = self._make_layer(layer3, outchannel=256, block_num=3, stride=2, train=self.is_training)
        with tf.variable_scope("layer5"):
            layer5 = self._make_layer(layer4, outchannel=512, block_num=3, train=self.is_training)
